...
//const aleatorio = Math.round( Math.random() * (10 -5) + 5); // numero aleatorio
//console.log(aleatorio);

//console.log(Math.PI);// PI
//console.log(Math.pow(2,10)); //Pontenciação

//console.log(num1 ** (1/2)); //raiz quadrada
//console.log(num1 ** 0.5); //raiz quadrada

console.log(100 / 0.00000000000000); // javascript permite divisão por 0, e em boolean avalia com TRUE (verdadeiro)
